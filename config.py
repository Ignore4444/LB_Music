...
OWNER_ID = int(getenv("OWNER_ID", "7770976628"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/NxCarderOfficial")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/NxCarderOfficialChat")
